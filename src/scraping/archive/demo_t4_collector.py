...
def show_next_steps():
    ...
    print("=" * 50)
    print("1. 运行完整测试:")
    print("   python src/scraping/test_t4_collector.py")
    print()
    print("2. 开发环境小规模采集:")
    print("   python src/scraping/run_t4_collector.py --env development")
    print()
    print("3. 生产环境采集:")
    print("   python src/scraping/run_t4_collector.py --env production"
    print()
    print("4. 查看详细文档:")
    print("   cat src/scraping/README_T4.md")
    print()
    print("5. 准备T5详情采集器:")
